...
import {
    CreateEventTraceResponseFromJSON,
    CreateEventTraceResponseToJSON,
    ErrorResponseFromJSON,
    ErrorResponseToJSON,
    EventsServiceCreateEventTraceBodyFromJSON,
    EventsServiceCreateEventTraceBodyToJSON,
...
export class EventsApi extends runtime.BaseAPI implements EventsApiInterface {
     ...
     * Creates request options for eventsServiceCreateEventTrace without sending the request
     */
    async eventsServiceCreateEventTraceRequestOpts(requestParameters: EventsServiceCreateEventTraceRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['eventId'] == null) {
            throw new runtime.RequiredError(
                'eventId',
                'Required parameter "eventId" was null or undefined when calling eventsServiceCreateEventTrace().'
            );
        }
        ...
        if (requestParameters['eventsServiceCreateEventTraceBody'] == null) {
            throw new runtime.RequiredError(
                'eventsServiceCreateEventTraceBody',
                'Required parameter "eventsServiceCreateEventTraceBody" was null or undefined when calling eventsServiceCreateEventTrace().'
            );
        }
        ...
        return {
            ...
            body: EventsServiceCreateEventTraceBodyToJSON(requestParameters['eventsServiceCreateEventTraceBody']),
        };
    }
     ...
     * Create event trace
     */
    async eventsServiceCreateEventTraceRaw(requestParameters: EventsServiceCreateEventTraceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateEventTraceResponse>> {
        const requestOptions = await this.eventsServiceCreateEventTraceRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => CreateEventTraceResponseFromJSON(jsonValue));
    }
     ...
     * Create event trace
     */
    async eventsServiceCreateEventTrace(requestParameters: EventsServiceCreateEventTraceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreateEventTraceResponse> {
