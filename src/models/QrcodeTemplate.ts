...
/**
 * Provides the reusable presets Linkbreakers suggests when teams create new links, bundling a design and copy so
 * campaigns start with on-brand defaults.
 * 
 * Templates can be either private (default) or public:
 * - Private templates (published_at is null): Only visible to the creating workspace
 * - Public templates (published_at is set): Visible to all workspaces in the gallery
 * - Built-in templates: Always public and maintained by Linkbreakers
 * @export
